...
Revision ID: 28da2d31c1cd
Revises: bb373b3b78e9
Create Date: 2023-04-15 10:39:35.183837
...
revision = '28da2d31c1cd'
down_revision = 'bb373b3b78e9'
branch_labels = None
depends_on = None
...
def downgrade() -> None:
    ...
    sa.PrimaryKeyConstraint('diagram_id', name='PK__sysdiagr__C2B05B61DCFEEC65')
    )
    # ### end Alembic commands ###
